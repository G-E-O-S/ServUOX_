...
namespace Server.Engines.Chat
{
    ...
    {
        public static readonly bool Enabled = Initialization.Get("Chat.Enabled", true);
        public static readonly bool AllowCreateChannels = Initialization.Get("Chat.AllowCreateChannels", true);
