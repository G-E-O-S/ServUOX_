...
namespace Server.Engines.VvV
{
    ...
    public class ViceVsVirtueSystem : PointsSystem
    {
        ...
        public static bool Enabled = Initialization.Get("VvV.Enabled", true);
        public static int StartSilver = Initialization.Get("VvV.StartSilver", 2000);
        public static bool EnhancedRules = Initialization.Get("VvV.EnhancedRules", false);
