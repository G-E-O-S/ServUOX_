...
namespace Server.Engines.CityLoyalty
{
	...
	{
        public static readonly bool Enabled = INI.Get("CityLoyalty.Enabled", true);
		public static readonly int CitizenJoinWait = INI.Get("CityLoyalty.JoinWait", 7);
		public static readonly int BannerCost = INI.Get("CityLoyalty.BannerCost", 250000);
        public static readonly int BannerCooldownDuration = INI.Get("CityLoyalty.BannerCooldown", 24);
        public static readonly int TradeDealCostPeriod = INI.Get("CityLoyalty.TradeDealPeriod", 7);
        public static readonly int TradeDealCooldown = INI.Get("CityLoyalty.TradeDealCooldown", 7);
        public static readonly int TradeDealCost = INI.Get("CityLoyalty.TradeDealCost", 2000000);
        public static readonly int TradeDealUtilizationPeriod = INI.Get("CityLoyalty.TradeDealUtilizationPeriod", 24);
        public static readonly int MaxBallotBoxes = INI.Get("CityLoyalty.MaxBallotBoxes", 10);
        public static readonly int AnnouncementPeriod = INI.Get("CityLoyalty.AnnouncementPeriod", 48);
