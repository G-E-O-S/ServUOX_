...
namespace Server.Misc
{
	public class ServerList
	{
        ...
        */
		...
		public static readonly string Address = INI.Get("Server.Address", default(string));

		public static readonly bool AutoDetect = INI.Get("Server.AutoDetect", true);

		public static string ServerName = INI.Get("Server.Name", "My Shard");
