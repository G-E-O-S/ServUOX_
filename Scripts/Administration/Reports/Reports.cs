...
namespace Server.Engines.Reports
{
    ...
    {
        public static bool Enabled = Initialization.Get("Reports.AutoGenerate", false);
        ...
        public static SkillDistribution[] GetSkillDistribution()
        {
            ...
            foreach (Mobile mob in World.Mobiles.Values)
            {
                if (mob.SkillsTotal >= 1500 && mob.SkillsTotal <= (Initialization.Get("PlayerCaps.TotalSkillCap", 7000) + 200) && mob is PlayerMobile)
                {
