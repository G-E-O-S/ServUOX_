...
namespace Server.Engines.Help
{
	...
	public class PageEntry
	{
		...
		public static readonly string SupportEmail = INI.Get("General.SupportEmail", default(string));
		public static readonly string SupportWebsite = INI.Get("General.SupportWebsite", default(string));
	...
	public class PageQueue
	{
		...
		public static readonly bool ShowStaffOffline = INI.Get("General.ShowStaffOffline", true);
